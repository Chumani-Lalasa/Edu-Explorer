...
#         signup_window = Tk()  # Create a new Tkinter window for registration
#         RegisterApp(signup_window)  # Initialize the RegisterApp with the new window
...
class LoginPage:
    ...
    def go_to_signup(self):
        self.window.destroy()  # Close the login window
        from register import RegisterApp  # Import here to avoid circular import
        signup_window = Tk()  # Create a new Tkinter window for registration
        RegisterApp(signup_window)  # Initialize the RegisterApp with the new window
        signup_window.mainloop()  # Run the new signup window
