...
# Import the EduExplorerApp class from the home_page module
from Home import EduExplorerApp  # Make sure this import statement is correct
...
class LoginPage:
    ...
    def authenticate_user(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.go_to_home()  # Navigate to home page after successful login
            else:
    ...
    def go_to_home(self):
        self.window.destroy()  # Close the login window
        root = tk.Tk()
        app = EduExplorerApp(root)  # Create instance of EduExplorerApp
        root.mainloop()
